                                            ...
                                            <div class="dropup products-item-cart">
                                                ...
                                                <div class="dropdown-menu products-item-cart-popup" aria-labelledby="dropdownMenu2">
                                                    <div class="input-group">
                                                        ...
                                                        <button class="btn btn-success products-item-cart-add_item" type="button" item-cart-link="${pageContext.request.contextPath}/products/add/${product.id}/"><span class="glyphicon glyphicon-ok"></span></button>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
