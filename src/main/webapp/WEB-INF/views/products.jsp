        ...
        <div class="container-fluid overflow-auto height-100">
            <div class="container page-main_box" id="products-main_box">
                <div id="products-filter" class="container-fluid row">
                    ...
                    <div class="col-md-1 col-md-offset-7 row float-right">
                        <div class="form-group">
                            <select id="products-filter-size" class="form-control input-sm">
            ...
            $(document).ready(function() {
                ...
                /*----------  Choose page size  ----------*/
                $('#products-filter-size').change(function() {
                    var tempSelectValue = $(this).val();

                    var tempCategory = '${category.id != null ? "category=" += category.id += "&" : ""}';

                    var tempLink = '${pageContext.request.contextPath}/${baseUrl}?' + tempCategory + 'page=${pagination.currentPage}&size=' + tempSelectValue;
